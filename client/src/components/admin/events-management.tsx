...
import { z } from 'zod';
import { Plus, Edit, Trash2, Search, Calendar as CalendarLucide, MapPin, Ticket, DollarSign } from 'lucide-react';
...
export function EventsManagement() {
  ...
  const eventStats = {
    ...
    totalRevenue: (events as any[]).reduce((sum, e) => sum + (e.ticketPrice * (e.totalTickets - e.availableTickets)), 0),
  };
      ...
      <Card className="bg-slate-800/50 backdrop-blur-sm border-slate-700">
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle className="text-white text-xl">Events Management</CardTitle>
